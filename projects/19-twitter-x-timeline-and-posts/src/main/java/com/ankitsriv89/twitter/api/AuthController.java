...
import com.ankitsriv89.twitter.config.JwtUtil;
import com.ankitsriv89.twitter.dto.TokenResponse;
...
public class AuthController {
    ...
    // Intentional for the tutorial UI — there is no user store in this project.
    // In production: verify a password hash (bcrypt/argon2) or delegate to OIDC.
    @PostMapping("/token")
